    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public void Update ()
        {
            ...
            if (Session.Raycast(m_firstPersonCamera.ScreenPointToRay(touch.position), raycastFilter, out hit))
            {
                ...
                {
                    Debug.Log("Number of cats allowed" + numberOfCatsAllowed);
                    Debug.Log("Number of cats generated" + currentNumberOfCats);
                    currentNumberOfCats++;
                    // Create an anchor to allow ARCore to track the hitpoint as understanding of the physical
                    // world evolves.
                    var anchor = Session.CreateAnchor(hit.Point, Quaternion.identity);
                ...
                {
                    //send the endPos to CatToMove
                    Debug.Log("CatObject" + catObject);
                    catObject.GetComponent<CatToMove>().StartMove(hit.Point);
                }*/
            }
        }
